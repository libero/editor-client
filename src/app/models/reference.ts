...
import {
  BookReference,
  ConferenceReference,
  createBookReference, createBookReferenceFromJson,
  createConferenceReference, createConferenceReferenceFromJson,
  createDataReference, createDataReferenceFromJson, createJournalReferenceFromJson,
  ...
  createPatentReference, createPatentReferenceFromJson,
  createPeriodicalReference, createPeriodicalReferenceFromJson,
  createPrePrintReference, createPrePrintReferenceFromJson,
  createReferencePersonList,
  createReportReference, createReportReferenceFromJson,
  createSoftwareReference, createSoftwareReferenceFromJson,
  createThesisReference, createThesisReferenceFromJson,
  createWebReference, createWebReferenceFromJson,
  DataReference,
  JournalReference,
  PatentReference,
  PeriodicalReference,
